...
namespace Fuckshadows.Encryption
{
    ...
    public static class OpenSSL
    {
        ...
        public const int OPENSSL_CIPHER_ENC_UNCHANGED = -1;
        ...
        {
            return EVP_get_cipherbyname(Encoding.ASCII.GetBytes(cipherName));
        }
        ...
        public static void ResetCtxNonce(IntPtr ctx, byte[] nonce)
        {
            var ret = EVP_CipherInit_ex(ctx, IntPtr.Zero,
                IntPtr.Zero, null,
                nonce,
                OPENSSL_CIPHER_ENC_UNCHANGED);
